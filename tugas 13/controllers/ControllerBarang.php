<?php 
    ...
    switch ($tombol) {
        ...
        header('Location:http://localhost/LatihanPHP_3_Biyan/crud_CR(13)/crud/CreateBarang.php');
            break;
    }

    // Landing Page
    header('Location:http://localhost/LatihanPHP_3_Biyan/crud_CR(13)/crud/Barang.php');
?>