<?php 
    ...
    switch ($tombol) {
        ...
        header('Location:http://localhost/LatihanPHP_3_Biyan/crud_CR(13)/crud/CreateProduk.php');
            break;
    }

    // Landing Page
    header('Location:http://localhost/LatihanPHP_3_Biyan/crud_CR(13)/crud/produk.php');
?>